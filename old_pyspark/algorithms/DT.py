...
class DT:
    ...
    def __init__(self, data, features, labelCol, maxDepth=5, maxBins=32, minInstancesPerNode=1, minInfoGain=0.0,
        ...
        self.dt = DecisionTreeClassifier(maxDepth=30, maxBins=128, minInstancesPerNode=5, maxMemoryInMB=4096,
                                         labelCol=labelCol)

        stages = [self.vectorAssembler, self.dt]
    ...
    def classification_report(self, predict, validate):
        ...
        print("############################DT############################")
        print('Accuracy for DT with settings ' + str(self.settings))
